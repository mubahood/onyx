@php $subject = 'Welcome to ONYX Advocates — Your Staff Account'; @endphp
@include('emails._header')
  ...
  <p style="font-size:14px;color:#5A4A3A;line-height:1.7;margin:0 0 24px;">
    Your staff account on the <strong>ONYX Advocates</strong> case management system has been created.
